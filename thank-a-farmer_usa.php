...
function app_start() {
  ...
  if($callme){    // Call out from "Call me button"
   ...
   if($callerage == "Age (optional)") $callerage="-";
	...
	mysql_query("INSERT INTO `calls` (callId, callertype, callerfname, callerlname, callerage,callercountry,callercity,callerprovince,calleremail,callernumber, callerchecked, callerlanguage) VALUES ('".$call_id."','". $callertype ."','". $callerfname ."','". $callerlname ."','". $callerage ."','" . $callercountry ."','" . $callercity."','". $callerprovince."','". $calleremail ."','". $callernumber. "','" .$callerchecked. "','en')");

  $language = "en";
  
  $tropo->say("http://aws.farmradio.org/thank-a-farmer/prompts/taf-usa-intro.wav");
